...
- To mimic real life streaming inputs, we should probably use **Stream Groups**. 
...
Change directories to the PX4-Autopilot directory. Run the simulation using:
...
```bash
source /Users/danyherrera/Projects/AI-Grand-Prix/Albatross/.venv-albatross/bin/activate
```
